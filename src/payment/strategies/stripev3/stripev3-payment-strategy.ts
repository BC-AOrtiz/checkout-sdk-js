...
import {
    ...
    StripeCardElement,
    StripeHandleCardPaymentOptions, StripePaymentMethodData,
...
export default class StripeV3PaymentStrategy implements PaymentStrategy {
    ...
    execute(payload: OrderRequestBody, options?: PaymentRequestOptions): Promise<InternalCheckoutSelectors> {
        ...
        const shouldSaveInstrument: boolean = payload && !!payload.shouldSaveInstrument;
                ...
                return this._paymentActionCreator.generatePaymentIntent(
                    ...
                    return this._getStripeJs().createPaymentMethod('card', this._cardElement, {
                        ...
                        return this._getStripeJs().handleCardPayment(
                            paymentIntent, stripeCardPaymentOptions
                        ).then(stripeResponse => {
